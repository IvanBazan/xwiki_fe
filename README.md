...
1. Предполагает наличие вышеупомянутых файлов по пути `/opt/backups/xwiki/latest`
2. Далее исполнение скрипта из директории с композом
![восстановление сервера](restore.sh)
